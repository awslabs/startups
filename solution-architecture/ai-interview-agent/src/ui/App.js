...
function App() {
  ...
  if (token) {
    return (
      <div className='livekit'>
        <div className='header'>
          <div className='title'>AI Interview - Amazon Leadership Principles</div>
  ...
  return (
    <div className='livekit'>
      <div className='header'>
        ...
        <div className='subtitle'>Amazon Leadership Principles Assessment</div>
      </div>
      
      <div className='join-form'>
        <h2>Welcome to Your Interview</h2>
        <p>You'll be interviewed on 4 Amazon Leadership Principles:</p>
        <ul>
