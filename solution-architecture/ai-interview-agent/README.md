...
An AI-powered video interview system using LiveKit and Amazon Bedrock Nova Sonic for real-time voice interviews based on Amazon Leadership Principles.
...
- 4 Amazon Leadership Principles coverage (random order)
...
4. Agent asks questions from 4 leadership principles (random order)
