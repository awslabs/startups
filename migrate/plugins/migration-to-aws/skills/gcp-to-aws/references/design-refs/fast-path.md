...
| PaaS / managed platform | Elastic Beanstalk — **only when `compute_model` is absent or `"managed_platform"`** | Preserves managed platform model; AWS manages deployments, scaling, patching, monitoring   |
