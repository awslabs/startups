...
- **CPU requests** match documented dyno CPU shares (standard-1x = 1 share ≈ 250m of a core)
...
|-----------|-------|--------|----------------|-------------------|----------------|
| m6i.large | 2 vCPU (2000m) | 8 GiB (8192Mi) | 1500m | 7680Mi | standard-1x, standard-2x, private-s |
| m6i.xlarge | 4 vCPU (4000m) | 16 GiB (16384Mi) | 3500m | 15872Mi | performance-m, private-m |
| m6i.4xlarge | 16 vCPU (16000m) | 64 GiB (65536Mi) | 15500m | 65024Mi | performance-l, private-l |

## Matching Rules

- **Exact case-insensitive matching**: dyno type string is compared case-insensitively (e.g., `Standard-1X` matches `standard-1x`)
- **Error on unknown types**: if the input dyno type is not one of the 7 recognized types listed above, the lookup produces a mapping rejection error indicating the unsupported dyno type name
