...
`checked` (the awsknowledge MCP confirmed model/region availability) · `fallback_static` (MCP
failed after retries; the static table in `vendored/ai/ai-migration-guardrails.md` was used).
