...
# only — no pricing. Active models only, per the llm-to-bedrock skill's ai-model-lifecycle.md
...
_PRICING_NOTE = ("Coarse family mapping only — see the llm-to-bedrock skill for detailed "
