...
regional availability come from the **`llm-to-bedrock` skill** — never quote dollar figures
...
when there is no feature override. Detailed pricing/TCO → the `llm-to-bedrock` skill.
