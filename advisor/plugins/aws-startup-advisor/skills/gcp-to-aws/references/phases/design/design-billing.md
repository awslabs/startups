...
| `google_app_engine_application`  | App Engine           | Elastic Beanstalk                      | Fargate (`compute_model: container_orchestration`), Lambda (`serverless`); EKS Auto Mode under `compute: "eks"` — see multi-cloud override below                                                                                                                                                                                                                                                                    |
