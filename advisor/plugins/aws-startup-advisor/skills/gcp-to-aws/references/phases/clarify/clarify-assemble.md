...
| Must stay portable                       | Multi-cloud row = Yes                                                              | Standard EKS Cluster only, no ECS Fargate; App Engine also routes to a Standard EKS Cluster (Q7b N/A, overrides default EB mapping) |
| Kubernetes-averse                        | Multi-cloud row = No + Q8 = option 3 (`kubernetes: "ecs-fargate"`)                 | ECS Fargate strongly recommended                                                                                                    |
