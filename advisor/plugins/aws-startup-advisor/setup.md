...
- **claude-platform-evaluation** — Chooses among the Anthropic API, Claude Platform on AWS, and Claude on Amazon Bedrock, then recommends the smallest useful validation test.
