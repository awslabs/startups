...
//
// Modes:
//   node pricing-staleness.ts [pluginPath]            # report; ALWAYS exit 0 (safe in `build`
//                                        # — a stale cache must not fail unrelated PRs)
//   node pricing-staleness.ts [pluginPath] --strict   # exit 1 when any cache is stale (for a
